...
<body>
	...
	<div id="ListUsers"><h3>List users to interact with:<button type="button" name="listUsers" id="listUsers" onclick="adminListUsers(e);">List</button></h3>
		<select name="listedUsers" id="listedUsers"></select><button type="button" name="EditUserList" id="EditUserList" onclick="adminEditUser(e);">Edit</button>
		<button name="DeleteUserList" id="DeleteUserList" onclick="adminDeleteUser(e);">Delete</button>
	</div>
