...
<style>
	...
	/* msgbox code - position it at the top and in the middle of the screen */
	#msgBox {
	  ...
	  left: 50%; /* Center the msgbox */
	  top: 30px; /* 30px from the bottom */
	}

	/* Show the msgbox when clicking on a button (class added with JavaScript) */
	#msgbox.show {
	  visibility: visible;
